...
Usage:
    ...
    uv run python idp_group_sync.py --domain acme.finitestate.io --mapping mapping.yaml

    # Preview changes without applying them
    uv run python idp_group_sync.py --domain acme.finitestate.io --mapping mapping.yaml --dry-run
    ...
    uv run python idp_group_sync.py --domain acme.finitestate.io --mapping mapping.csv \
        --remove-unlisted-members

    # Verbose output
    uv run python idp_group_sync.py --domain acme.finitestate.io --mapping mapping.yaml --verbose
...
logger = logging.getLogger("idp_group_sync")
